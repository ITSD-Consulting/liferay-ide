...
public class LiferayTomcat90Configuration extends Tomcat90Configuration implements ILiferayTomcatConfiguration {

	public LiferayTomcat90Configuration(IFolder path) {
		super(path);
	}
