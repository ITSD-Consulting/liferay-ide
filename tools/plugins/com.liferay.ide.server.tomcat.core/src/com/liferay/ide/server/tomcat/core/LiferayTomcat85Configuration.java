...
public class LiferayTomcat85Configuration extends Tomcat85Configuration implements ILiferayTomcatConfiguration {

	public LiferayTomcat85Configuration(IFolder path) {
		super(path);
	}
